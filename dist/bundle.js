...
const playerActions = {
  ...
  matchWinCheck() {
    if ((0,_Game__WEBPACK_IMPORTED_MODULE_0__.getTurn)() === 0) {
      return false;
    }
    if (this.score === 5) {
      return true;
